...
struct TimelineExplanationTexts: View {
    var body: some View {
        Group {
            ...
            Text("The timelines from ingestions with the same substance where substances have onset, comeup, peak and offset defined are combined into a cumulative timeline by simply putting the individual lines on top of each other. This is not done for ingestions where either the onset, comeup, peak or offset duration is missing or if the \"draw redoses individually\" toggle is enabled.")
