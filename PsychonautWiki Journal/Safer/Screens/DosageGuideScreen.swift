...
struct DosageGuideScreen: View {
    var body: some View {
        List {
            Text(
"""
Dosage refers to the size or amount of an administered psychoactive substance.
...
""")
     ...
     """)
            ...
            Section("Volumetric Liquid Dosing") {
                Text(
                         """
