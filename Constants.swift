...
"""
    ...
    static let substancesDisclaimerIOS = substancesDisclaimerWatch +
"""


Tap the link on the left to read the corresponding PsychonautWiki article on the wanted and unwanted effects of an individual substance.
"""
}
